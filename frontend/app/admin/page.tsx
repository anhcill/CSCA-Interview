...
import { Activity, BarChart3, BookOpen, Bot, ClipboardList, GraduationCap, Upload, User } from "lucide-react";
...
const quickActions = [
  ...
  { href: "/admin/ai-usage", icon: Activity, label: "Sử dụng AI", tone: "bg-indigo-600 text-white" },
